...
const MOVE_STEP = 30; // Pixels to move per key press
const RESIZE_STEP = 20; // Pixels to resize per key press

// Email settings
const EMAIL_CONFIG = {
  recipient: 'lalvani.arya@gmail.com', // Replace with the email where you want to receive screenshots
  // SMTP configuration - you need to provide your own email service details
  smtp: {
    host: 'smtp.gmail.com', // e.g., smtp.gmail.com
    port: 587,
    secure: false, // true for 465, false for other ports
    auth: {
      user: 'denilcollins@gmail.com', // Your email address
      pass: 'qpxqtbtuvfhxuybw'     // Your email password or app password
    }
  }
};
